  ...
  outputs = {
    ...
    in {
      ...
      devShells.default = pkgs.mkShell.override useMold {
        ...
        DB_PRELOADS = "/home/grant/Documents/ipdbs/dbip-city-ipv4-num.csv.gz:/home/grant/Documents/ipdbs/dbip-city-ipv6-num.csv.gz";
        ...
        buildInputs = with pkgs; [
          ...
          (writeShellScriptBin "db-webserver"
            ''
              ${pkgs.python3}/bin/python -m http.server -d dbs/
            '')
        ];
